...
class VistaCostos(ttk.Frame):
    def __init__(self, parent):
        ...
        # ── KPIs ────────────────────────────────────────────────
        fila_titulo_kpis = ttk.Frame(cuerpo)
        fila_titulo_kpis.pack(fill="x")
        from app.ui.tutorial_overlay import boton_ayuda_contextual
        from app.ui.tutorial_data import AYUDA_CONTEXTUAL
        titulo_costos, texto_costos = AYUDA_CONTEXTUAL["costos"]
        boton_ayuda_contextual(fila_titulo_kpis, titulo_costos, texto_costos,
                                side="right")
