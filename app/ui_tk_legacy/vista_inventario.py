...
class VistaInventario(ttk.Frame):
    ...
    def _pestana_lotes(self, notebook):
        ...
        fila_ayuda_fifo = ttk.Frame(pestana)
        fila_ayuda_fifo.pack(fill="x", pady=(0, 6))
        ttk.Label(
            fila_ayuda_fifo,
        ...
        titulo_fifo, texto_fifo = AYUDA_CONTEXTUAL["fifo"]
        boton_ayuda_contextual(fila_ayuda_fifo, titulo_fifo, texto_fifo,
                                side="left", padx=(6, 0))
