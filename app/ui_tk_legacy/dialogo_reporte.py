...
class DialogoReporte(tk.Toplevel):
    ...
    def _construir_ui(self):
        ...
        self.btn_vista_previa.grid(row=0, column=6, padx=(20, 4))
        ...
        # Alias sin guión bajo: lo usa el tutorial (tutorial_data.py)
        # para resaltar este botón sin tocar el resto de la clase.
        self.btn_guardar = self._btn_guardar
